...
Before starting the benchmark, read the knowledge notes listed in the skill's frontmatter `references:` list — they live in ${CLAUDE_PLUGIN_ROOT}/knowledge-notes/.
